...
export const PensionsTextEng = ["The size of a person’s pension is linked to his or her working-age wage through the pension insurance component, joint component and payments into the second pillar. One year of employment is added in the case of persons who earn at least the minimum wage for a whole year. This means that the current gender differences in wages would extend into the future even if the duration of employment is the same.","Размер пенсии человека привязан к его или ее заработной плате в трудоспособном возрасте через компонент пенсионного страхования, совместный компонент и выплаты во втором уровне. Один год работы добавляется к лицам, которые зарабатывают как минимум минимальную заработную плату в течение целого года. Это означает, что существующие гендерные различия в заработной плате сохранятся и в будущем, даже если продолжительность занятости будет такой же.","Pensioni suurus on seotud tööea palgaga pensioni kindlustusosa, ühendosa ja teise samba sissemaksete kaudu. Üks aasta tööstaaži lisandub neile, kes teenivad terve aasta jooksul vähemalt miinimumpalka. See tähendab, et praegused soolised palgaerinevused kanduksid tulevikku üle isegi võrdse tööstaaži korral."];
