...
export const wageDifferencesTextEng = [
  "The wages and salaries application shows differences in the monthly gross wages of full-time employees by sex, county and occupation. For information about an occupation in Estonia as a whole, click on “Overall in Estonia“ below the map title. For further information, select „Background“ from the main menu.",
  ...
  'Palgarakendus näitab täistööajaga töötajate brutokuupalga erinevust soo, maakondade ning ametialade kaupa. Ametiala kohta kogu Eestis saab infot, kui klõpsata kaardil pealkirja all sõnapaaril „Kogu Eesti“. Loe täpsemalt menüüst "Selgitused".',
];
export const wageForecastTextEng = [
  "If the wages and salaries of each occupation were to grow at the same pace as before 2019 and if the total wage growth of all occupations followed the long-term projections of the Ministry of Finance, the wages in 2030 would be at the level shown in the table below. In any given occupation, the more there are people in these jobs who retire, the easier it is to find work in that occupation. In the more distant future, robots and computers may replace humans in several occupations.",
...
export const PensionsTextEng = [
  "The size of a person’s pension is linked to his or her working-age wage through the pension insurance component, joint component and payments into the second pillar. One year of employment is added in the case of persons who earn at least the minimum wage for a whole year. This means that the current gender differences in wages would extend into the future even if the duration of employment is the same.",
...
export const LivelihoodEng = [
  "The 16.9% difference in monthly salaries between men and women will change to a 9.5% pension gap over time, but will not disappear.",
