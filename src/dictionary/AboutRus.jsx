        ...
        <div className="text-left body-stat">
          <ul className={"ol-stat"}>
            <li>
              ...
              — для распределения профессий в приложении используется
              классификатор профессий 
              <a href="http://metaweb.stat.ee/classificator_publish_list.htm?siteLanguage=ee">
              (http://metaweb.stat.ee/classificator_publish_list.htm?siteLanguage=ee)
              </a>
              , где профессии делятся на четко определенные группы в
              зависимости от содержания работы, рабочих обязанностей и
              квалификации, необходимой для работы. Эстонская
              внутригосударственная классификационная состоит из пяти уровней,
              первые четыре из которых соответствуют международной базовой
              классификации ISCO-08 (International Standard Classification of
              Occupations, 2008).
              <br />
              <br />
              Чтобы пояснить иерархию классификации профессий, рассмотрим,
              например, исходя из трудового регистра, профессию садовника. Она
              относится к профессиональной группе «Садовники, работники
              питомников и садоводы». В общем плане он является
              квалифицированным рабочим в области растениеводства и еще в более
              общем плане — квалифицированным рабочим сельского хозяйства. Все
              квалифицированные рабочие сельского хозяйства принадлежат к
              основной группе профессий «Квалифицированные рабочие в сельском,
              ...
              отображаться заработная плата, зависит от размера уезда и
              количества работающих в нем. В крупных уездах заработная плата
            ...
            <li>
              <p className="body-stat-bold" style={{ display: "inline" }}>
                ...
                средней заработной платы в Эстонии
              </p>{" "}
              — сумма частей первой и второй пенсионных ступеней в месяц,
              рассчитанная на основе предположений, представленных на странице
              прогноза пенсий в год выхода на пенсию, поделенная на среднюю
              месячную брутто-зарплату в Эстонии в том же году. На графике
            ...
            <li>
              ...
              ранжированные значения заработных плат (или пенсий) на десять
              равных частей, меньше первого дециля только 10% значений самых
              низких заработных плат (пенсий), меньше второго дециля 20% от
              самых низких значений и т.д. Децили даны в процентах на оси «y»
              слева от медианы, т.е. кумулятивно перед пятым децилем, справа от
              медианы децили показаны на оси как сто минус дециль в процентах,
            ...
            <li>
              ...
              — это среднее арифметическое, сумма заработных плат всех
            ...
            <li>
              ...
              — это уровень заработной платы, при котором одна половина
              работающих получают больше него, а другая половина — меньше.
              Например, медианная заработная плата в размере 1000 евро означает,
            ...
            <li>
              ...
              — в прогнозе использовался рост заработной платы по каждой
              профессии с сентября 2018 года по сентябрь 2019 года.
              Средневзвешенная заработная плата по всем профессиям в 2019 году
              была скорректирована до официальной средней заработной платы в
              2019 году, а средневзвешенная заработная плата по всем профессиям
              в 2030 году была скорректирована до прогнозируемой Министерством
              экономики и инфраструктуры средней заработной платы в этом году.
            ...
            <li>
              ...
              Осборна (2017). Наименования профессий SOC, использованные в
              статье, были согласованы с кодами ISCO через SOC Crosswalk (слабые
              ...
              <ul className="ol-stat-bullet">
                ...
                <li>
                  средняя, если ее значение находится в промежутке от 0,3 до
                  0,7;
                </li>
                <li>высокая, если она составляет более 0,7.</li>
              </ul>
              Оценка фокусируется на том, сколько работников данной профессии
              технологически смогут заменить компьютеры в неопределенном
              будущем. Точного прогноза, сколько рабочих мест будет фактически
              автоматизировано или как быстро это произойдет, не дается.
              Дополнительная информация о вероятностях: Frey, C. B., & Osborne,
              M. A. (2017). The future of employment: How susceptible are jobs
            ...
            <li>
              ...
              — количество людей данной профессии старше 55 лет, поделенное на
              общее количество работающих на полную ставку. Необходимость замены
              указана в таблице следующим образом:
              <ul className="ol-stat-bullet">
                <li>
